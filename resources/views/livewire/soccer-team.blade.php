        ...
        <div class="p-5">
            <div class="">
                ...
                <form action="" class="flex flex-col">
                    <div class="mb-5">
                        <label for="teamName" class="font-bold mb-1 text-gray-700 block">Nombre del equipo</label>
                        <div class="w-full">
                            <input type="string" wire:model.live='name' id="teamName" autocomplete="" class="input input-bordered w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none
                            focus:shadow-outline text-gray-600 font-medium">
                        </div>
                    </div>

                    <div class="mb-5">
                        <label for="visitorTeam" class="font-bold mb-1 text-gray-700 block">Estado</label>
                        <div class="w-full">
                            <select wire:model.live='status' id="visitorTeam" class="select select-bordered w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none
                            focus:shadow-outline text-gray-600 font-medium">
                                @foreach (App\Enums\SoccerTeams::cases() as $item)
                    ...
                    <div class="mb-5">
                        <label for="visitorTeam" class="font-bold mb-1 text-gray-700 block">Puntos</label>
                        <div class="w-full">
                            <input type="number" wire:model.live='points' id="visitorTeam" min="0" autocomplete=""
                                class="input input-bordered w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none
                            focus:shadow-outline text-gray-600 font-medium">
                        </div>
                    </div>
                    <div class="">
            ...
            <div class=" overflow-hidden sm:rounded-lg flex flex-col p-5">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex gap-3 flex-col md:flex-row">
                        <button class="bg-blue-500 hover:bg-blue-800 rounded-md text-white p-2"
                            wire:click='openModal'>Crear equipo</button>
                        ...
                        <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow ">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" wire:click='delete({{$item->id}})'
                                    wire:confirm='¿Esta seguro de desactivar "{{$item->name}}" del sistema?'
